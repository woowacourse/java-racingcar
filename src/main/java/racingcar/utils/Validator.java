...
public class Validator {
    ...
    public static void checkName(final String nameString) {
        final String[] names = nameString.split(DELIMITER);
    ...
    private static boolean isBlankOrNull(final String nameString) {
        return nameString == null || nameString.isEmpty();
    }

    public static void checkInput(final String nameString) {
    ...
    private static void checkInvalidNameString(final String nameString) {
    ...
    public static void checkBlankOrNull(final String nameString) {
    ...
    public static void checkCount(final String countString) {
        try {
