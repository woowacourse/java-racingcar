...
public class Validator {
    ...
    private static final String ALPHABET_FORMAT = "^[a-zA-Z]+$";
    ...
    private static final String CAR_NAME_ALPHABET_ERROR_MSG = "자동차 이름은 알파벳 대소문자로만 구성되어야 합니다.";
    ...
    private static void validateCarNamesFormat(final String carName) {
        ...
        if (!Pattern.matches(ALPHABET_FORMAT, carName)) {
            throw new IllegalArgumentException(CAR_NAME_ALPHABET_ERROR_MSG);
        }
    }
