...
public class RacingCarError {
    ...
    public static void lowerLength() {
        throw new IllegalArgumentException(LOWER_LENGTH_MESSAGE);
    }

    public static void upperLength() {
        throw new IllegalArgumentException(UPPER_LENGTH_MESSAGE);
    }
