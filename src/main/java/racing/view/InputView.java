...
import racing.game.CarNameInputHandler;
import racing.game.RoundNumInputHandler;
...
public class InputView {
    ...
    public static List<Car> getCars() {
        ...
        try {
            return CarNameInputHandler.getCars(SCANNER.nextLine());
            //차 이름을 차 객체들로 변환
        } catch (Exception e) {
    ...
    public static int getRoundNumber() {
        ...
        try {
            return RoundNumInputHandler.getRoundNumber(SCANNER.nextLine());
        } catch (Exception e) {
