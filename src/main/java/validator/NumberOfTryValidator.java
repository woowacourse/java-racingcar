...
public class NumberOfTryValidator {
    ...
    private static void validateNullAndEmpty(final String numberOfTry) {
        if (Objects.isNull(numberOfTry) || numberOfTry.isBlank()) {
            throw new IllegalArgumentException("빈 값을 입력할 수 없습니다.");
        }
    }

    private static void validateNotNumeric(final String numberOfTry) {
    ...
    private static void validateTryNumberRange(final int numberOfTry) {
