...
class CarNameInputViewTest {

  @Test
  @DisplayName("정상 동작 테스트")
  void getName() {
    List<String> testNames = CarNameInputView.getName("testA,testB,testC");
  ...
  void getNameFailByWrongNameLength(String input) {
    Assertions.assertThatThrownBy(() -> CarNameInputView.getName(input))
