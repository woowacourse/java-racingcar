...
class StringCalculatorTest {
    ...
    public void splitAndSum_쉼표구분자() {
        final int result = StringCalculator.splitAndSum("1,2");
    ...
    public void splitAndSum_쉼표와콜론구분자() {
        final int result = StringCalculator.splitAndSum("1:2,3");
    ...
    public void splitAndSum_커스텀구분자() {
        final int result = StringCalculator.splitAndSum("//;\n1;2;3");
        assertThat(result).isEqualTo(6);
    }
    ...
    void splitAndSum_null() {
        final int result = StringCalculator.splitAndSum(null);
        assertThat(result).isEqualTo(0);
    }
