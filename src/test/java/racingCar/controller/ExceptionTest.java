...
public class ExceptionTest {
    ...
    void 이름이_5자보다_큰_경우() {
        ...
        //then
        assertThatThrownBy(() -> racingCarsService.initiateCars(RequestService.requestNames(Input.inputNames())))
    ...
    void 라운드수_숫자가_아닐_경우() {
        ...
        //then
        assertThatThrownBy(() -> racingCarsService.initiateCount(RequestService.requestCount(Input.inputCount())))
