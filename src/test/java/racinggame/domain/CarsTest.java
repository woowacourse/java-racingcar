...
public class CarsTest {
    ...
    public void create() throws Exception {
        Assertions.assertThatCode(() -> Cars.of(List.of(Name.from("아톰"), Name.from("이상"))))
    ...
    public void createCarSizeException() throws Exception {
        Assertions.assertThatCode(() -> Cars.of(List.of(Name.from("아톰"))))
    ...
    public void createCarDuplicatedException() throws Exception {
        Assertions.assertThatCode(() -> Cars.of(List.of(Name.from("이상"), Name.from("이상"))))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    @Test
    void moveAll() {
        Cars cars = Cars.of(List.of(Name.from("아톰"), Name.from("이상")));
