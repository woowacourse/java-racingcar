...
public class NameValidatorTest {
	...
	void onlyName() {
		Assertions.assertThatThrownBy(() -> validateName("pobi"))
	...
	void longName() {
		Assertions.assertThatThrownBy(() -> validateName("summer,crong"))
			.isInstanceOf(IllegalArgumentException.class)
	...
	void duplicateName() {
		Assertions.assertThatThrownBy(() -> validateName("pobi,pobi"))
			.isInstanceOf(IllegalArgumentException.class)
