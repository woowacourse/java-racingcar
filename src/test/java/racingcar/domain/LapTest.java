...
class LapTest {
    ...
    void lap_숫자가_아닌_경우_예외처리() {
        assertThatThrownBy(() -> Lap.initGoalLap("hi")).isInstanceOf(IllegalArgumentException.class);
    }

    @Test
    @DisplayName("1보다 작은 값을 입력한 경우")
    void lap_1보다_작은_경우_예외처리() {
        assertThatThrownBy(() -> Lap.initGoalLap("0")).isInstanceOf(IllegalArgumentException.class);
    }
