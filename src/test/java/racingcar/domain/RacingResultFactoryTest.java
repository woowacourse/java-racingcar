...
public class RacingResultFactoryTest {

    private static RacingResultFactory racingResultFactory = new RacingResultFactory();
    ...
    static void makeRacingResultFactory() {
        ...
        racingResultFactory.setResult(racingResult1);
        ...
        racingResultFactory.setResult(racingResult2);
    ...
    void checkResultFactorySize() {
        assertThat(racingResultFactory.size()).isEqualTo(2);
    }

    @DisplayName("해당 회차의 레이싱 결과 리턴")
    @Test
    void checkResultFactoryReturn() {
        assertThat(racingResultFactory.getEpisodeResult(1).get(car1)).isEqualTo(1);
        assertThat(racingResultFactory.getEpisodeResult(1).get(car2)).isEqualTo(0);
        assertThat(racingResultFactory.getEpisodeResult(2).get(car1)).isEqualTo(2);
        assertThat(racingResultFactory.getEpisodeResult(2).get(car2)).isEqualTo(1);
    }
