...
public class TestDataManager {
    ...
    public static Cars getCarsTestData() {
        TestMovingStrategy pobiTestMovingStrategy = new TestMovingStrategy(new int[]{5, 8, 7, 3});
        TestMovingStrategy crongTestMovingStrategy = new TestMovingStrategy(new int[]{1, 2, 4, 5});
        TestMovingStrategy eddyTestMovingStrategy = new TestMovingStrategy(new int[]{6, 4, 8, 1});
