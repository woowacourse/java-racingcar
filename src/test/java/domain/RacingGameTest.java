...
class RacingGameTest {
    ...
    @Test
    @DisplayName("자동차 이름 정상 입력(2): 경계값 테스트")
    ...
    @Test
    @DisplayName("자동차 이름 예외 입력(1): 자동차 이름에 중복이 있어서는 안 된다.")
    ...
    @Test
    @DisplayName("자동차 이름 예외 입력(2): 입력이 비어 있으면 안 된다.")
    ...
    @Test
    @DisplayName("자동차 이름 예외 입력(3): 쉼표만 입력하면 안 된다.")
    ...
    @Test
    @DisplayName("자동차 이름 예외 입력(4): 이름은 하나의 쉼표로 구분되어야 한다.")
