...
public class StringAddCalculatorTest {
    ...
    void calculate_null_또는_빈문자() {
        String value = null;
        Assertions.assertThat(StringAddCalculator.calculate(value)).isEqualTo(0);
    ...
    void calculate_쉼표_콜론_구분자로_숫자합_계산() {
        String value = "1,2";
        Assertions.assertThat(StringAddCalculator.calculate(value)).isEqualTo(3);

        value = "1:2";
        Assertions.assertThat(StringAddCalculator.calculate(value)).isEqualTo(3);

        value = "1,2:3";
        Assertions.assertThat(StringAddCalculator.calculate(value)).isEqualTo(6);
    }
