...
class CarsTest {
    ...
    void Cars_checkDuplicate() {
        List<String> carNames = List.of("포인", "비니", "마크", "비니");
    ...
    void moveCars() {
        cars.moveCars(move);
        List<CarDto> actual = cars.bringCarsInformation();
        CarDto first = new CarDto("포인", 1);
        CarDto second = new CarDto("비니", 2);
        CarDto third = new CarDto("마크", 3);
        List<CarDto> expected = List.of(first, second, third);
    ...
    void findWinner() {
        ...
        CarDto third = new CarDto("마크", 3);
        List<CarDto> expected = List.of(third);
