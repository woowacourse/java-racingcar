...
+ Model
- [ ] 상태 관리 로직만 가진다.
- [ ] 자신이 가진을 상태 값을 관리하는 로직만을 담당하도록 한다.
- [ ] 상태 값을 검증하는 기능을 생성자 등에서 처리한다.

## 기타 확인 사항
- [ ] 컨벤션 위배 사항 확인
- [ ] 인덴트 depth 1 초과 사항 확인
- [ ] 하나의 메서드가 하나의 기능만을 하고 있는지 확인
- [ ] setter/getter 무분별한 사용 확인
- [ ] else 예약어 사용 확인
- [ ] 메서드 길이 15라인 초과 확인
- [ ] displayName 명시적인 이름 작성 확인
- [ ] Class 및 메서드 명시적인 이름 작성 확인

## 의문점
어떤 기준으로 테스트 할 코드를 분류 할 것인가?

랜덤 값 생성 처리 어떻게 할 것인가?

본 미션에서 Service Layer를 따로 두는것이 맞는 것인가?

랜덤 값 생성 테스트를 어떻게 해볼까?
